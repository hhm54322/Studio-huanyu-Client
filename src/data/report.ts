...
export const reportData = {
  ...
  countries: [
    { flag: '🇨🇳', name: '中国（推荐）', fee: '$15,000 - $25,000', wait: '7-14天', tech: '保乳及综合治疗路径成熟，预后需结合分期、病理和治疗反应评估', service: '国际医疗部全流程英文服务', visa: '医疗签证快速通道，48小时邀请函', follow: '术后1/3/6/12月随访，远程云病房' },
  ...
  hospitals: [
    ...
    { city: '上海', name: '复旦大学附属肿瘤医院', reason: '肿瘤专科经验丰富，适合进行病理复核与综合治疗评估' },
